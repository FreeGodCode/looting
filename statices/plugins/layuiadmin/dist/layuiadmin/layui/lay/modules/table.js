		...
		if(a.startTime = (new Date).getTime(), n.url) {
			...
			n.contentType && 0 == n.contentType.indexOf("application/json") && (s = JSON.stringify(s)), t.ajax({
				...
				success: function(t) {
					...
					t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t.data, e, t.data[r.countName]), d(), n.time = (new Date).getTime() - a.startTime + " ms"), i && l.close(i), "function" == typeof n.done && n.done(t.data, e, t.data[r.countName])
				},
				error: function(e, t) {
					layui.layer.closeAll();
